...
def set_holiday_doodle(bot: TS3Bot):
    ...
    if today.month == 2 and 12 <= today.day <= 14:
        ...
        if today.month == 4 and 14 <= today.day <= 18:
            return bot.change_host_banner_image(BANNERS['easter'])
        elif today.month == 5 and today.day == 26:
            return bot.change_host_banner_image(BANNERS['fathers day'])
    elif today.year == 2023:
        if today.month == 4 and 6 <= today.day <= 10:
            return bot.change_host_banner_image(BANNERS['easter'])
        elif today.month == 5 and today.day == 18:
            return bot.change_host_banner_image(BANNERS['fathers day'])
    elif today.year == 2024:
        if today.month == 3 and 28 <= today.day <= 31:
            return bot.change_host_banner_image(BANNERS['easter'])
        elif today.month == 5 and today.day == 9:
            return bot.change_host_banner_image(BANNERS['fathers day'])
    else:
